<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="供应商属性">
              <j-dict-select-tag type="select" v-model="queryParam.supplierProp" dictCode="supp_prop"
                placeholder="请选择供应商属性" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <a-form-item label="供应商性质">
              <j-dict-select-tag type="select" v-model="queryParam.supplierType" dictCode="supp_type"
                placeholder="请选择供应商性质" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24" v-if="activeKey == '0'">
            <a-form-item label="供应商状态">
              <j-dict-select-tag type="select" v-model="queryParam.status" dictCode="supp_status" placeholder="请选择状态"
                @change="setVal" />
            </a-form-item>
          </a-col>
          <a-col :xl="6" :lg="7" :md="8" :sm="24" v-if="activeKey != '0'">
          ...
          <a-col :xl="6" :lg="7" :md="8" :sm="24">
            <span style="float: right;overflow: hidden;" class="table-page-search-submitButtons">
              ...
              <a-button type="primary" icon="download" @click="handleExportXls('供应商基本信息')"
    ...
    <div>
      ...
      <a-table ref="table" size="middle" bordered rowKey="id" :scroll="{ x: 1200, y: 500 }" :key="key" :columns="columns"
        :dataSource="dataSource" :pagination="ipagination" :components="components" :loading="loading"
    ...
    <a-drawer title="履历" :width="width" placement="right" :closable="false" destroyOnClose :visible="visible2">
      <a-table ref="table" size="middle" bordered rowKey="id" :scroll="{ x: true, y: 500 }" :columns="columns1"
        :dataSource="resumeList" :pagination="false" :loading="loading">
      </a-table>
    ...
    <a-drawer title="履历" :width="width" placement="right" :closable="false" destroyOnClose :visible="visible1">
      <j-form-container>
    ...
    <a-drawer title="冻结" :width="width" placement="right" :closable="false" destroyOnClose :visible="visible">
      <!-- 主表单区域 -->
      <j-form-container>
