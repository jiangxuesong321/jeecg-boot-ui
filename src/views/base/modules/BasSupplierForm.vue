...
<!--          </a-col>-->
          ...
          <a-col :span="8" >
            <a-form-model-item label="供应商属性" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
              <j-dict-select-tag type="select" v-model="model.supplierProp" dictCode="supp_prop" placeholder="请选择供应商属性" />
            </a-form-model-item>
          </a-col>
          <a-col :span="8" >
            <a-form-model-item label="供应商性质" :labelCol="spans.labelCol3" :wrapperCol="spans.wrapperCol3">
              <j-multi-select-tag type="select" v-model="model.supplierType" dictCode="supp_type" placeholder="请选择供应商性质" />
            </a-form-model-item>
          </a-col>
    ...
    data() {
      return {
        ...
        validatorRules: {
          ...
          supplierProp: [
            { required: true, message: '请选择供应商属性!'},
          ],
          supplierType: [
