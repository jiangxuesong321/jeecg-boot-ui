      ...
      <table width="100%" style="border: 1px solid black; border-collapse:collapse;">
            <thead>
              <tr style="height: 50px">
                ...
                <th style="background-color:#fafafa; border: 1px solid #DDDDDD;width: 180px">设备信息</th>
                <th style="background-color:#fafafa; border: 1px solid #DDDDDD;width: 120px">采购量(台)</th>
